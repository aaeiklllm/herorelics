...
define gui.hover_color = u'#8F7D64'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = u'#A2988A'
...
define gui.name_text_font = "helveticabold.ttf"
...
define gui.slot_button_borders = Borders(90, 40, 20, 20)
...
define config.thumbnail_width = 302
define config.thumbnail_height = 245
...
## Horizontal borders.
define gui.bar_borders = Borders(30, 30, 30, 30)
